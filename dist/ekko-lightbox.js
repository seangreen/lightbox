...
(function() {
  ...
  EkkoLightbox = function(element, options) {
    ...
    this.modal_id = this.options.modal_id ? this.options.modal_id : 'ekkoLightbox-' + Math.floor((Math.random() * 1000) + 1);
        header = '<div class="modal-header"' + (this.options.title || this.options.always_show_close ? '' : ' style="display:none"') + '><button type="button" class="close" data-dismiss="modal" aria-hidden="true">' + ( this.options.close_txt ? this.options.close_txt : '&times;' ) + '</button><h4 class="modal-title">' + (this.options.title || "&nbsp;") + '</h4></div>';
